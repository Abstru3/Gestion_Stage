...
--
-- Client :  localhost
-- Généré le :  Mer 05 Février 2025 à 08:44
...
INSERT INTO `entreprises` (`id`, `user_id`, `siret`, `nom`, `adresse`, `ville`, `code_postal`, `pays`, `telephone`, `site_web`, `lieu`, `tva_intracommunautaire`, `secteur_activite`, `description`, `adresse_facturation`, `logo`, `nom_contact`) VALUES
(1, 4, '', 'Nom de l\'entreprise', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
